...
mydata = read.csv("D:\\FYP_DATA\\JAVA\\DATA_GENERATION_RECONFIGURATION\\COMBINED_6PLUSR_20170212_RECONFIGURED_FILTERED.csv")  # read csv file 
...
write(km2$cluster, file = "D:\\R\\ATTITUDE_EXAMPLE\\clusters3.txt", sep = ",")

...
mydata = read.csv("D:\\FYP_DATA\\JAVA\\DATA_GENERATION_RECONFIGURATION\\20170217_C1to6_R_COMB_RECONFIGURED_FILTERED.csv")  # read csv file 
...
write(km2$cluster, file = "D:\\R\\ATTITUDE_EXAMPLE\\clusters123.txt", sep = ",")
